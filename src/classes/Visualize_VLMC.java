 ...
 * @author fabinhosano
 */
public final class Visualize_VLMC extends Display {
    ...
    public Visualize_VLMC(FileParser fileParser) {
    ...
    private JButton createButtonSimulate() {
        ...
        buttonSimulate.setMaximumSize(new Dimension(6, 15));
    ...
    private void setSelectedRadioButtonRadial(Boolean selected) {
        this.radioButtonRadial.setSelected(selected);
    }

    private void setSelectedRadioButtonTree(Boolean selected) {
