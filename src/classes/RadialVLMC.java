 ...
 * @author fabinhosano
 */
public class RadialVLMC extends Display {
    ...
    private static RadialVLMC radialVLMC;

    public RadialVLMC(Graph g, String label) {
    ...
    public static void main(String argv[]) {
        ...
        radialVLMC.setBackgroundImage(freeChart
    ...
    public static JPanel demo(final String label) {
        ...
        try {
            ...
            JPrefuseTable.showTableWindow(data);
    ...
    public static JPanel demo(Graph g, final String label) {
        ...
        radialVLMC = new RadialVLMC(g, label);
        Visualization vis = radialVLMC.getVisualization();
        ...
        radialVLMC.addControlListener(new ControlAdapter() {
        ...
        panel.add(radialVLMC, BorderLayout.CENTER);
